...
CREATE TABLE IF NOT EXISTS `group_capacity` (
  ...
  `max_aggr_size` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '聚合子配置最大大小上限',
...
CREATE TABLE IF NOT EXISTS `his_config_info` (
  ...
  `tenant_id` varchar(128) DEFAULT '' COMMENT '租户字段',
  `encrypted_data_key` varchar(1024) NOT NULL DEFAULT '' COMMENT '密钥',
  `publish_type` varchar(64) DEFAULT 'formal' COMMENT 'publish type gray or formal',
  `ext_info` longtext DEFAULT '' COMMENT 'ext info',
  PRIMARY KEY (`nid`),
