...
public class ValidationUtils {
     ...
     * @param message 错误消息
     */
    public static void validateDateRange(java.time.LocalDate date, java.time.LocalDate start, java.time.LocalDate end, String message) {
     ...
     * @param message 错误消息
     */
    public static void validateDateTimeRange(java.time.LocalDateTime dateTime, java.time.LocalDateTime start, java.time.LocalDateTime end, String message) {
     ...
     * @param message 错误消息
     */
    public static void validateFileExtension(String fileName, String[] allowedExtensions, String message) {
