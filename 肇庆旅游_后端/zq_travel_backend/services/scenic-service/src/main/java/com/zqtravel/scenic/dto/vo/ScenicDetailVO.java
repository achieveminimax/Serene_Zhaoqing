package com.zqtravel.scenic.dto.vo;
...
public class ScenicDetailVO {
    ...
    @Schema(description = "空气质量等级", example = "优")
    ...
    @Schema(description = "相关景点ID列表")
    private List<Long> relatedSpotIds;

    @Schema(description = "相关景点名称列表")
    private List<String> relatedSpotNames;
}